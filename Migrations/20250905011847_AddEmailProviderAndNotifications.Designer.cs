...
namespace WebsiteBuilderAPI.Migrations
{
    ...
    [Migration("20250905011847_AddEmailProviderAndNotifications")]
    partial class AddEmailProviderAndNotifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.Cat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.Components.StructuralComponentsSettings", b =>
                {
                    ...
                    b.Property<string>("WhatsAppWidgetConfig")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.ContactMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.ContactNotificationSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("DashboardNotificationsEnabled")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("PlaySoundOnNewMessage")
                        .HasColumnType("boolean");

                    b.Property<string>("ToastErrorMessage")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.Property<string>("ToastSuccessMessage")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.ToTable("ContactNotificationSettings");
                });
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.EmailProviderSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.Gato", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.Perro", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.WhatsAppConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("AutoReplySettings")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("GreenApiInstanceId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("GreenApiToken")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<string>("GreenApiTokenMask")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.Property<string>("HeaderValueTemplate")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.Property<string>("TwilioAccountSidMask")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.Property<string>("TwilioAuthTokenMask")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.WhatsAppConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.WhatsAppMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.ContactMessage", b =>
                {
                    ...
                    b.HasOne("WebsiteBuilderAPI.Models.User", "ReadByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.WhatsAppConversation", b =>
                {
                    b.HasOne("WebsiteBuilderAPI.Models.User", "AssignedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.WhatsAppMessage", b =>
                {
                    ...
                    b.HasOne("WebsiteBuilderAPI.Models.WhatsAppConversation", "Conversation")
                        .WithMany("Messages")
                    ...
                    b.HasOne("WebsiteBuilderAPI.Models.User", "RepliedByUser")
                        .WithMany()
                        .HasForeignKey("RepliedByUserId");
