...
namespace WebsiteBuilderAPI.DTOs.WhatsApp
{
    ...
    public class WhatsAppConfigDto
    {
        ...
        public string? WebhookSecret { get; set; } = string.Empty; // Decrypted secret for display/editing
    ...
    public class UpdateWhatsAppConfigDto
    {
        ...
        [StringLength(200)]
        public string? HeaderValueTemplate { get; set; }
        ...
        /// <summary>
        /// Additional settings in JSON format (for widget config, etc.)
        /// </summary>
        public string? AdditionalSettings { get; set; }
    }
